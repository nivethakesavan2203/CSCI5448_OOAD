...
public class SUV extends CarRental.Inventory {
    public enum Cars{
        SUV1, SUV2, SUV3, SUV4, SUV5
    }
    ...
    public SUV(String customerName) {
        super();
        for (String key : countDays.keySet()) {
            if (countDays.get(key) == 0) {
        ...
        this.childSeatCost = 15;
        this.GPSModuleCost = 20;
        this.satelliteRadioCost = 25;
